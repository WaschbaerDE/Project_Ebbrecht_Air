...
public class Testdaten {
    ...
    public void airportsTest () {
        ...
        Airport fra = new Airport("erea","eraf",50.033306,8.570456,18000,"asda","3800",0,"1990", 0);
        airportsArray.add(fra);


        Airport rio = new Airport("erea","eraf",-89.908333,-120.196388,18000,"asda","3800",0,"1990", 1);
        airportsArray.add(rio);


        Airport ber = new Airport("erea","eraf",52.362247,13.500672,18000,"asda","3800",0,"1990", 1);
        airportsArray.add(ber);


        Airport sao = new Airport("erea","eraf",-23.426944,-47.165833,18000,"asda","3800",0,"1990", 0);
        airportsArray.add(sao);


        Airport tok = new Airport("erea","eraf",35.553333,139.781111,18000,"asda","3800",0,"1990", 1);
        airportsArray.add(tok);


        Airport sfr = new Airport("erea","eraf",37.618806,-122.375417,18000,"asda","3800",0,"1990", 0);
